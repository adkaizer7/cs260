...
var mainColumn = new Column({
	...
	contents: [
		new Line ({left: 0, right: 0, top: 0, bottom: 0, skin: topSkin,
			contents:[
				new Label({left:0, right:0, height:30, string:"Sanitas", style: titleStyle}),
				new Picture({left:0, right:0, top:0, bottom:0, height: 30, url:"dataviz.png"}),
				]}),
		temperatureLabel,
		bpLabel,
		heartRateLabel,
		ceLabel,
		new Line ({left: 0, right: 0, top: 0, bottom: 0, skin: bottomSkin,
			contents:[
				]}),			
	],
	behavior: Behavior({
