...
var topSection = new Container({
	...
	contents:[
		new BackButton(),
		new Label({left:0, right:0, top: 0, bottom:0, height:0, string: "Health-Data-Name", style:titleStyle}),
...
var middleSection = new Container({
	...
	contents:[
		new GraphContainer(),
		new Label({left:0, right:0, top:360, bottom:0, height:0, string: "Sampling Rate: Every "+(plotterParams.interval/1000)+" s", style:labelStyle}),
